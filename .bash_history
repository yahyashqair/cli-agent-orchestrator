claude --append-system-prompt '# DEVELOPER AGENT
...
Remember: Your success is measured by how effectively you translate requirements into working, maintainable code that meets the specified needs while adhering to best practices.' --mcp-config '{"mcpServers":{"cao-mcp-server":{"type":"stdio","command":"uvx","args":["--from","git+https://github.com/awslabs/cli-agent-orchestrator.git@main","cao-mcp-server"]}}}'
claude --append-system-prompt '# DEVELOPER AGENT
